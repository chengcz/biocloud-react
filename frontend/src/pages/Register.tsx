/** Register page component - DeepSeek style */
    ...
    <div className="min-h-screen flex items-center justify-center bg-white dark:bg-gray-900 transition-colors duration-200">
      ...
      <div className="max-w-md w-full p-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">注册账号</h1>
          <p className="text-gray-500 dark:text-gray-400 text-sm">创建您的 BioCloud 账号</p>
        </div>
